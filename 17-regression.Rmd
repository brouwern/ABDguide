...
17.1-2 is a very important figure showing how the residuals change when different lines are fit to the data.
...
17.1-3 shows the difference between positive (+), negative (-), and flat (0) slopes.
